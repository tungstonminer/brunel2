...
recipes.addShaped(<wearablebackpacks:backpack>, [
    [<ore:leather>,       <ore:ingotBronze>,   <minecraft:leather>],
    [<minecraft:leather>, <ore:blockWool>,     <minecraft:leather>],
    [<minecraft:leather>, <minecraft:leather>, <minecraft:leather>]
]);
recipes.addShaped(<wearablebackpacks:backpack>, [
    [<ore:leather>,       <ore:ingotCopper>,   <minecraft:leather>],
    [<minecraft:leather>, <ore:blockWool>,     <minecraft:leather>],
    [<minecraft:leather>, <minecraft:leather>, <minecraft:leather>]
]);
...
recipes.addShaped(<chickenchunks:chunk_loader>, [
    ...
    [<minecraft:gold_ingot>, <minecraft:obsidian>,   <minecraft:gold_ingot>]
]);
